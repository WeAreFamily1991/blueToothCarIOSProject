...
@implementation CommentOrderSmallTimeCellView
...
//        self.frameHeight=lbEndAddress.frameYH+10;
        self.frameHeight=lbRTime.frameYH+20;
        [self setAddUpdataBlock:^(id data, id weakme) {
            lbDate.text=[[data ojk:@"starttime_str"] firstObject];
            lbTime.text=[NSString stringWithFormat:@"%@%@",[[data ojk:@"starttime_str"] objectAtIndex:1],[[data ojk:@"starttime_str"] lastObject]];
            lbRDate.text=[[data ojk:@"endtime_str"] firstObject];
            lbRTime.text=[NSString stringWithFormat:@"%@%@",[[data ojk:@"endtime_str"] objectAtIndex:1],[[data ojk:@"endtime_str"] lastObject]];
...
//            [lbEndAddress setColor:rgb(0, 0, 0) contenttext:kS(@"main_order", @"drop_off")];
            //            day
            lbCenterTime.text=[NSString stringWithFormat:@"%@  %@",[data ojsk:@"days"],kS(@"order_detail", @"day")];
        }];
    }
