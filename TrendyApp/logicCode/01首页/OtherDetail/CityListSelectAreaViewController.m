...
#import "CityListSelectAreaViewController.h"
#import "CitylistPopView.h"
@interface CityListSelectAreaViewController ()
@property(nonatomic,strong)CitylistPopView*viewContent;
@end

@implementation CityListSelectAreaViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    CitylistPopView*viewContent=[CitylistPopView viewWithFrame:CGRectMake(0, kTopHeight, 0, 0) backgroundcolor:nil superView:self.view];
