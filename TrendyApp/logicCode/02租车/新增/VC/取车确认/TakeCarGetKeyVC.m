...
@interface TakeCarGetKeyVC ()

@end

@implementation TakeCarGetKeyVC
...
-(void)setUI
{
    UILabel *titleLabel = [UILabel labelWithText:@"請取出i button" font:[UIFont boldSystemFontOfSize:WScale(17)] textColor:BlackColor backGroundColor:ClearColor textAlignment:NSTextAlignmentLeft superView:self.view];
    ...
    ///开始用车
    UIButton *nextBtn =  [UIButton buttonWithTitle:@"开始用车" font:kFont(16) titleColor:WHITECOLOR backGroundColor:UIColorFromRGB(0x0E70A1) buttonTag:0 target:self action:@selector(nextBtnClick) showView:self.view];
