...
@interface AlsoCarCloseDoorVC ()

@end

@implementation AlsoCarCloseDoorVC
...
-(void)nextBtnClick
{
    AlsoCarTimerVC *timerVC = [[AlsoCarTimerVC alloc] init];
...
-(void)setUI
{
    ...
    [unlockBtn setImage:[UIImage imageNamed:@"btn_close_large"] forState:UIControlStateNormal];
    [unlockBtn setImage:[UIImage imageNamed:@"btn_close_large"] forState:UIControlStateHighlighted];
    ...
    UILabel *titleLabel = [UILabel labelWithText:@"請鎖車門" font:[UIFont boldSystemFontOfSize:WScale(17)] textColor:BlackColor backGroundColor:ClearColor textAlignment:NSTextAlignmentLeft superView:self.view];
