...
+(void)showMyDemo{
    ...
    ProductKeysView*tv=[[ProductKeysView alloc]init];
//    tv.delegate = tv;
    tv.frame = CGRectMake(0, 64, kScreenWidth, kScreenHeight - 64);
    [tv showAllArray:@[@"哈哈哈",@"哈哈哈哈",@"哈哈",@"哈哈",@"哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈",@"哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈哈"]];

    [UTILITY.currentViewController.view addSubview:tv];
