...
- (void)setValueDefaultImage:(UIImage *)tImage DefaultImageName:(NSString *)strImage cacheUrl:(NSString *)cacheUrl urlImage:(NSString *)strUrl indexPath:(NSIndexPath *)indexPath tapGesture:(UITapGestureRecognizer *)gesture
{
    ...
    if ([strUrl notEmptyOrNull]) {
        ...
        [tmp.imageView imageWithURL:strUrl useProgress:YES useActivity:NO defaultImageData:imageT];
    }
...
- (void)saveImage{
    ...
    [[PHPhotoLibrary sharedPhotoLibrary] performChanges:^{ // 这个block里保存一些"修改"性质的代码
        ...
        PHAssetChangeRequest *createAssetRequest = [PHAssetChangeRequest creationRequestForAssetFromImage:self.tmp.image];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImage *imaget=[dic objectForJSONKey:@"DefaultImage"];
    if ([[dic valueForJSONStrKey:@"DefaultPath"] notEmptyOrNull]) {
        imaget=[UIImage imageWithContentsOfFile:[dic valueForJSONStrKey:@"DefaultPath"]];
    }
    [cell setValueDefaultImage:imaget  DefaultImageName:[dic valueForJSONStrKey:@"DefaultName"] cacheUrl:[dic valueForJSONStrKey:@"cacheUrl"] urlImage:[dic valueForJSONStrKey:@"url"] indexPath:indexPath tapGesture:gesture];
    return cell;
}
