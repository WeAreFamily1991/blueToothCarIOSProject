...
- (void)scrollToPage:(NSUInteger)pageNumber animated:(BOOL)abool{
    if (pageNumber < _pageCount) {
        ...
        switch (self.orientation) {
            case NewPagedFlowViewOrientationHorizontal:
                [_scrollView setContentOffset:CGPointMake(_pageSize.width * self.page, 0) animated:abool];
                break;
            case NewPagedFlowViewOrientationVertical:
                [_scrollView setContentOffset:CGPointMake(0, _pageSize.height * self.page) animated:abool];
                break;
        }
