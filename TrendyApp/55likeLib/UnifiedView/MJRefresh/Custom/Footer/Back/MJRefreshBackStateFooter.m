...
//    [self setTitle:[NSBundle mj_localizedStringForKey:MJRefreshBackFooterNoMoreDataText] forState:MJRefreshStateNoMoreData];
    [self setTitle:kS(@"refresh", @"refresh_footer_pullup") forState:MJRefreshStateIdle];
    [self setTitle:kS(@"refresh", @"refresh_footer_release") forState:MJRefreshStatePulling];
    [self setTitle:kS(@"refresh", @"refresh_footer_loading") forState:MJRefreshStateRefreshing];
    [self setTitle:kS(@"refresh", @"refresh_footer_allloaded") forState:MJRefreshStateNoMoreData];
}
