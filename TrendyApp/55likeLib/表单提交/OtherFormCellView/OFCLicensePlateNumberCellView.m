...
#import "OFCLicensePlateNumberCellView.h"
@interface OFCLicensePlateNumberCellView()<UITextFieldDelegate>
{
    
}
@end
@implementation OFCLicensePlateNumberCellView
- (void)addSimplicView{
...
-(void)addFCView{
    ...
    self.defaultTextfield.frameWidth=85;
    self.defaultTextfield.frameRX=15;
     WSSizeButton*btnSelect=[RHMethods buttonWithframe:CGRectMake(0, 0, 100, self.frameHeight) backgroundColor:nil text:@"沪" font:16 textColor:rgb(51, 51, 51) radius:0 superview:self];
    [btnSelect setImageStr:@"arrowb01" SelectImageStr:nil];
    [btnSelect setBtnImageViewFrame:CGRectMake(0, 0, 12, self.frameHeight)];
    btnSelect.imgframeRX=0;
    btnSelect.imageView.contentMode=UIViewContentModeScaleAspectFit;
    [btnSelect setBtnLableFrame:CGRectMake(0, 0, btnSelect.frameWidth-12-5, btnSelect.frameHeight)];
    btnSelect.titleLabel.textAlignment=NSTextAlignmentRight;
    btnSelect.frameRX=105.5;
