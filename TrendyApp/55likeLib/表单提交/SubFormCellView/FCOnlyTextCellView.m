...
#import "FCOnlyTextCellView.h"

@implementation FCOnlyTextCellView
- (void)addSimplicView{
...
//    self.frameHeight=44;
    ...
    self.defaultTextfield.hidden=YES;
    UIView*viewBG=[UIView viewWithFrame:CGRectMake(15, 10, kScreenWidth-30, 140) backgroundcolor:rgb(246, 246, 246) superView:self];
